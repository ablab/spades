...
void inline split(std::vector < std::string > &vec, std::string const
...
void inline load_split(std::vector < std::string > &vec, boost::property_tree::ptree const
& pt,
...
template<class T>
void inline load(std::vector <T> &vec, boost::property_tree::ptree const &pt, std::string const &key,
             bool /*complete*/) {
