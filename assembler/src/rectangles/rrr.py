...
def save_fasta(bgraph, output_path, is_sc, name_file):
    bgraph.condense()
    graph = bgraph.project(output_path, is_sc)
...
def resolve(input_path, output_path, test_utils, genome, is_sc):
    ...
    outgraph = save_fasta(maxbgraph, output_path, is_sc, "after_deleting_big_loops.fasta")
