...
class Cluster {
 ...
 public:
  typedef std::unordered_map<ScaffoldVertex, MappingInfo>::const_iterator const_iterator;
  ...
  std::vector<MappingInfo> GetMappings() const {
...
namespace std {
template<>
struct hash<path_extend::read_cloud::cluster_storage::Cluster> {
  size_t operator()(const path_extend::read_cloud::cluster_storage::Cluster &cluster) const {
      using std::hash;
...
template<>
struct hash<path_extend::read_cloud::cluster_storage::Cluster::MappingInfo> {
  size_t operator()(const path_extend::read_cloud::cluster_storage::Cluster::MappingInfo &info) const {
      using std::hash;
