...
class GraphClusterStorageBuilder {
  public:
    ...
    GraphClusterStorageBuilder(const Graph &g,
                               const std::shared_ptr<FrameBarcodeIndexInfoExtractor> barcode_extractor_ptr,
                               const size_t distance)
        : g_(g), cluster_merger_(g), barcode_extractor_ptr_(barcode_extractor_ptr), distance_threshold_(distance) {}
