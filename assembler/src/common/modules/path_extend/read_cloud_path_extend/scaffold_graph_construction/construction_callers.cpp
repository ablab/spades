...
shared_ptr<path_extend::scaffold_graph::ScaffoldGraphConstructor> BarcodeScoreConstructorCaller::GetScaffoldGraphConstuctor(
    ...
    LabeledDistributionThresholdFinder threshold_finder(g_, raw_barcode_extractor_, EDGE_LENGTH_THRESHOLD,
                                                        params.length_threshold_, MIN_DISTANCE, MAX_DISTANCE,
                                                        SCORE_PERCENTILE, max_threads_);
...
shared_ptr<path_extend::scaffold_graph::ScaffoldGraphConstructor> CompositeConnectionConstructorCaller::GetScaffoldGraphConstuctor(
    ...
    path_extend::LongEdgePairGapCloserParams predicate_params(params.connection_count_threshold_,
                                                              params.tail_threshold_,
                                                              params.connection_score_threshold_,
                                                              params.relative_coverage_threshold_,
