...
std::shared_ptr<path_extend::scaffold_graph::ScaffoldGraph> ScaffoldGraphConstructionPipeline::GetResult() const {
...
ScaffoldGraphConstructionPipeline BasicScaffoldGraphPipelineConstructor::ConstructPipeline(
    ...
    auto initial_constructor =
        std::make_shared<path_extend::scaffold_graph::UniqueScaffoldGraphConstructor>(gp_.g,
                                                                                      unique_storage_,
                                                                                      scaffold_vertices,
...
GapScaffoldGraphPipelineConstructor::GapScaffoldGraphPipelineConstructor(
    ...
    : ScaffoldGraphPipelineConstructor(gp, lib, configs),
      ...
      max_threads_(max_threads),
      min_length_(min_length) {}
std::shared_ptr<scaffold_graph::ScaffoldGraphConstructor> GapScaffoldGraphPipelineConstructor::GetInitialConstructor(
    ...
    auto initial_constructor =
        std::make_shared<path_extend::scaffold_graph::ScoreFunctionScaffoldGraphConstructor>(gp_.g,
                                                                                             scaffold_vertices,
                                                                                             score_function,
                                                                                             score_threshold,
                                                                                             max_threads_);
...
FullScaffoldGraphPipelineConstructor::FullScaffoldGraphPipelineConstructor(
    ...
    BasicScaffoldGraphPipelineConstructor(gp, lib, configs, unique_storage, barcode_extractor, max_threads,
                                          min_length),
...
BinningScaffoldGraphPipelineConstructor::BinningScaffoldGraphPipelineConstructor(
        ...
        size_t max_threads,
        size_t min_length)
    : GapScaffoldGraphPipelineConstructor(gp, lib, configs, unique_storage, barcode_extractor, max_threads,
                                          min_length) {}
