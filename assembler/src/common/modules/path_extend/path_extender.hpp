...
public:
    ...
    ShortLoopResolver(const Graph& g, std::shared_ptr<ShortLoopEstimator> loop_estimator)
            : g_(g), loop_estimator_(loop_estimator) { DEBUG("ShortLoopResolver");}
...
public:
    LoopDetectingPathExtender(const conj_graph_pack &gp,
            ...
            : PathExtender(gp.g),
              ...
              cov_map_(cov_map) {
        DEBUG("LoopDetectingPathExtender");
...
public:
    ...
    SimpleExtender(const conj_graph_pack &gp,
        ...
        weight_threshold_(weight_threshold) { DEBUG("SimpleExtender");}
