...
#./spades_compile.sh
./spades.py --sc --only-assembler -m 160 -k 21,33,55 -1 data/input/E.coli/sc_lane_1/bh20111014/human_filtered_paired_left.fastq.gz -2 data/input/E.coli/sc_lane_1/bh20111014/human_filtered_paired_right.fastq.gz -s data/input/E.coli/sc_lane_1/bh20111014/human_filtered_single_left.fastq.gz -s data/input/E.coli/sc_lane_1/bh20111014/human_filtered_single_right.fastq.gz -o /tmp/data/output/spades_output/ECOLI_SC_LANE_1_BH_woHUMAN
