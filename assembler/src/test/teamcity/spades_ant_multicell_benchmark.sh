...
srun -w ant03 ./src/test/teamcity/teamcity.py /tmp/data/input/E.coli/is480/ECOLI_IS480_QUAKE_MANUAL.info >> ./ant_benchmark/ECOLI_IS480_QUAKE_$timestamp.log 2>> ./ant_benchmark/ECOLI_IS480_QUAKE_$timestamp.log &
echo "done"

echo "Starting L.grasseri on ant03..."
rm -f ./ant_benchmark/LGRASSERI_QUAKE.log
srun -w ant03 ./src/test/teamcity/teamcity.py /tmp/data/input/L.grasseri/LGRASSERI_QUAKE_MANUAL.info >> ./ant_benchmark/LGRASSERI_QUAKE_$timestamp.log 2>> ./ant_benchmark/LGRASSERI_QUAKE_$timestamp.log &
echo "done"


echo "Starting B.faecium on ant03..."
rm -f ./ant_benchmark/BFAECIUM_QAUKE.log
srun -w ant03 ./src/test/teamcity/teamcity.py /tmp/data/input/B.faecium/BFAECIUM_QAUKE_MANUAL.info >> ./ant_benchmark/BFAECIUM_QAUKE_$timestamp.log 2>> ./ant_benchmark/BFAECIUM_QAUKE_$timestamp.log &
echo "done"
