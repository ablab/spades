...
./spades.py --only-error-correction -1 data/input/E.coli/is220/corrected/s_6.first1000_1.fastq.gz -2 data/input/E.coli/is220/corrected/s_6.first1000_2.fastq.gz
