...
for line in flist:
	os.system(bowtie + 'bowtie -p 8 -c ' + format + ' --minins ' + str(minins) + ' --maxins ' + str(maxins) + ' ' + orient + ' ' + outdir + 'index/' + output_genome + ' ' + line + ' --al ' + line + file_suff + ' > /dev/null 2> ' +  outdir + 'errlog' + file_suff)
