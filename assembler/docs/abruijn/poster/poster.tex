...
\node[rectangle,anchor=west,text width=25cm,inner sep=5mm] at (28,61.5) {
  ...
  {\color{OrangeRed}\bf Output:} the genome $S$.\\
  ~\\
...
\begin{scope}
  ...
  \node[rectangle,text width=28cm,anchor=north west] at (25,22) {
...
\item 
Pevzner, Tang, Tesler.
\newblock De novo repeat classification and fragment assembly.
