...
\begin{figure}
\begin{center}
\subfloat[]{\includegraphics[width=.9\textwidth]{ATGCATTGCACTGCA_debruijn.pdf}}\\
\subfloat[]{\includegraphics[width=.9\textwidth]{ATGCATTGCACTGCA_earmark.pdf}}
\end{center}
...
Fig.~\ref{fig:tipexample}(a). Assume now that only $3$-mers
...
in Fig.~\ref{fig:repeatexample}(a), in the de Bruijn graph built on $3$-mers
...
are not earmarked, see Fig.~\ref{fig:repeatexample}(b).


\begin{figure}
\caption{A small repeat in a de Bruijn graph (a) may be resolved
in an earmarked graph (b) in case $k$-mers from the repeated region are
not earmarked.}\label{fig:repeatexample}
\begin{center}
\includegraphics[width=0.45\textwidth]{fig6_de.pdf}
\includegraphics[width=0.45\textwidth]{fig6_ear.pdf}
\end{center}
\end{figure}
