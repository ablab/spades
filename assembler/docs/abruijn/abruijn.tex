...
\begin{figure}
\caption{De Bruijn (grey) and A Bruijn (black) graphs of a genome {\tt ACTGACTGTTGACACTG} ($readsize=9$, $k=5$).
and {\tt ATTGGTACATTGTGGTACGTACTGACT} ($readsize=11$, $k=5$).}\label{fig23}
\begin{center}\includegraphics[height=0.5\textheight]{fig2.jpg}
~~~~~~~~~~~~~~
\includegraphics[height=0.5\textheight]{fig3.jpg}\end{center}
\end{figure}
...
\begin{center}\includegraphics[height=0.9\textheight]{fig4.jpg}\end{center}
\end{figure}
