...
The plot below show the dependence of the number of vertices in a graph from the 
number of reads.

\begin{tikzpicture}
    \begin{axis}[xlabel={$\#$ of reads},ylabel={$\#$ of vertices in a graph}]
    \addplot[smooth,mark=*,blue] plot coordinates { (4000,3567) (6000,6718) (10000,16786) };
