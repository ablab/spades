...
\begin{enumerate}
\item De Bruijn graph construction and index of $K$-mers.
...
%%%%%%%%%%%%%%%CONSTRUCTION
\begin{scope}
  \draw (0,55) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (54,47);
...
%%%%%%%%%%%%%%%ERRORS
\begin{scope}
  \draw (0,44) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (54,34);
...
%%%%%%%%%%%%%%%INFO
\begin{scope}
  \draw (0,31) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (54,21);
