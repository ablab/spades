...
%%%%%%%%%%%%%%%CONSTRUCTION
\begin{scope}
  \draw (0,55) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (26,47);
  \node[draw=SteelBlue3,line width=2mm,rounded corners=.5cm,anchor=south west,fill=blue!10!white,inner sep=3mm] at (0,55) {\fontsize{32pt}{1em} \bf 
    Graph Construction\phantom{y}};
 \node[rectangle,anchor=west,text width=24cm,inner sep=5mm] at (0,51) {
\begin{itemize}
...
\item 2 bits per nucleotide in sequences. 0 bits overhead for sequences with compile-time lengths (i.e. $K$).
...
%%%%%%%%%%%%%%%GRAPH PIC
\begin{scope}
%  \draw (36,44) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (54,21);
%  \node[draw=SteelBlue3,line width=2mm,rounded corners=.5cm,anchor=south west,fill=blue!10!white,inner sep=3mm] at (36,44) {\fontsize{32pt}{1em} \bf 
%    Errors Handling\phantom{y}};
 \node[rectangle,anchor=west,text width=18cm,inner sep=5mm] at (41,32.5) {
\includegraphics[height=24cm]{graph_simple.pdf}
 };
\end{scope}

%%%%%%%%%%%%%%%ERRORS
\begin{scope}
  \draw (0,44) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (41,34);
  \node[draw=SteelBlue3,line width=2mm,rounded corners=.5cm,anchor=south west,fill=blue!10!white,inner sep=3mm] at (0,44) {\fontsize{32pt}{1em} \bf 
    Errors Handling\phantom{y}};
 \node[rectangle,anchor=west,text width=35cm,inner sep=5mm] at (0,39) {
\begin{itemize}
\item \textbf{Tip clipping}.
\item \textbf{Bulge removal}.
\item \textbf{Low-coverage edges removal}.
\end{itemize}
 };
\end{scope}
...
%%%%%%%%%%%%%%%INFO
\begin{scope}
  \draw (0,31) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (41,21);
  \node[draw=SteelBlue3,line width=2mm,rounded corners=.5cm,anchor=south west,fill=blue!10!white,inner sep=3mm] at (0,31) {\fontsize{32pt}{1em} \bf 
    Additional Info\phantom{y}};
 \node[rectangle,anchor=west,text width=35cm,inner sep=5mm] at (0,26) {
\begin{itemize}
\item Coverage.
\item Distances between edges.
\end{itemize}
 };
\end{scope}
...
%%%%%%%%%%%%%%%PRACTICAL RESULTS
\begin{scope}
  \draw (0,18) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (35,0);
...
\node[rectangle,anchor=west,text width=25cm,inner sep=5mm] at (0,9) {
...
%%%%%%%%%%%%%%%CONCLUSION
\begin{scope}
  \draw (36,18) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (54,11);
  \node[draw=SteelBlue3,line width=2mm,rounded corners=.5cm,anchor=south west,fill=blue!10!white,inner sep=3mm] at (36,18) {\fontsize{32pt}{1em} \bf 
    Conclusions\phantom{y}};
\node[rectangle,anchor=west,text width=17cm,inner sep=5mm] at (36,14.5) {
 Something was done.
 };
\end{scope}
...
%%%%%%%%%%%%%%%FUTURE
\begin{scope}
  \draw (36,8) [color=SteelBlue3,line width=2mm,rounded corners=.5cm] rectangle (54,0);
  \node[draw=SteelBlue3,line width=2mm,rounded corners=.5cm,anchor=south west,fill=blue!10!white,inner sep=3mm] at (36,8) {\fontsize{32pt}{1em} \bf 
    Future\phantom{y}};
\node[rectangle,anchor=west,text width=17cm,inner sep=5mm] at (36,4) {
