...
\end{center}
\begin{abstract}
 In this paper we give a general definition for repeat resolving methods, based on paired information usage. We prove that rectangle graph technic is a honest repeat resolving method in case of error-free data, and provide some ideas how to improve rectangle graph approach, and how can inexact mate-read gaps be overcame.
\end{abstract}
