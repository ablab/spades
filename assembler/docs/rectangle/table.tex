  ...
  %       an unbiased 
        ...
        %were from http://www.ecogene.org/\;.
         ...
         Velvet-IDEAL is given for comparison. Velvet-IDEAL is the Velvet assembly of single reads of length 220, with repeat resolution by single reads (Velvet's option \texttt{long}).
