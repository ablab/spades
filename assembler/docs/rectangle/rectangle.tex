...
The objective of any jigsaw puzzle is the rearragement of these pieces into a single structure such that 
neighboring pieces share identical boundaries as well as having similar color
and texture near the boundaries.
...
While usual applications of jigsaw problems are often limited to 
the assembly and repair of broken objects or 
the restoration of archeological findings, in this paper, we show that our simplified jigsaw puzzle
directly relates to the problem of assemblying genomes from mate-pairs. 
We implemented the rectangle graphs as a separate module of  SPADES assembler and 
demonstrate that it out-performs other methods in both 
