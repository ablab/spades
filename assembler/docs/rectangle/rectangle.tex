...
perturbed around its original position. The task of assemblying the diagonal grid graph from in-exact mate pairs is analogous to 
...
the collection, or even some of the pieces are missing.  
