...
-   Performance statistics is given for SPAdes version 3.12.0.
...
To download [SPAdes Linux binaries](http://cab.spbu.ru/files/release3.12.0/SPAdes-3.12.0-Linux.tar.gz) and extract them, go to the directory in which you wish SPAdes to be installed and run:
...
To obtain [SPAdes binaries for Mac](http://cab.spbu.ru/files/release3.12.0/SPAdes-3.12.0-Darwin.tar.gz), go to the directory in which you wish SPAdes to be installed and run:
...
If you meet these requirements, you can download the [SPAdes source code](http://cab.spbu.ru/files/release3.12.0/SPAdes-3.12.0.tar.gz):
