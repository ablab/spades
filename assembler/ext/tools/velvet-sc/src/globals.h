...
#define LMER 12
#define READ_MAP_PENALTY_THRESH 30
#define N_PENALTY 0
#define AC_MISMATCH_PENALTY 1
#define AG_MISMATCH_PENALTY 1
#define AT_MISMATCH_PENALTY 1
#define CG_MISMATCH_PENALTY 1
#define CT_MISMATCH_PENALTY 1
#define GT_MISMATCH_PENALTY 1

#if defined(_WIN32) || defined(__WIN32__) || defined(WIN32)
#define inline __inline
extern struct tString_st;
extern struct readSet_st;
extern struct fastQrecord_st;
extern struct splayTable_st;
extern struct lmerIndex_st;
...
typedef struct fastQrecord_st Record;

// Hash table structures
typedef struct splayTable_st SplayTable;
typedef struct lmerIndex_st LMerIndex;
