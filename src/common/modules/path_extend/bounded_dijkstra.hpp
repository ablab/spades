...
//            DEBUG("Intersection " << barcode_extractor_->AreEnoughSharedBarcodesWithFilter(decisive_edge_, edge))
...
//            size_t current_barcodes = barcode_extractor_->GetNumberOfBarcodes(edge);
