...
TEST( PathExtend, BidirectionalPathConstructor ) {
    ...
    auto path2 = BidirectionalPath::create(g, start);
    ...
    v.push_back(e1);
    v.push_back(e2);
    auto path3 = BidirectionalPath::create(g, v);
    ...
    auto path4 = BidirectionalPath::create(path3);
...
TEST( PathExtend, BidirectionalPathSubpaths ) {
    ...
    path1->PushBack(e2, Gap(10));
    path1->PushBack(e3, Gap(10));
    auto path3 = BidirectionalPath::create(path1->SubPath(1));
    EXPECT_EQ(path3->Size(), 2);
...
TEST( PathExtend, BidirectionalPathSearch ) {
    ...
    auto path5 = BidirectionalPath::create(g);
    path5->PushBack(e4);
    path5->PushBack(e5);
    path5->PushBack(e6);
    path5->PushBack(e5);
